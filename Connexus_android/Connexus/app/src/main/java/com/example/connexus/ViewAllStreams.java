...
import com.example.connexus.activities.NearbyStreams;
import com.example.connexus.activities.SearchStreams;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ViewAllStreams.this, SearchStreams.class);
                intent.putExtra("query", te_search_criteria.getText().toString().trim());
        ...
        btn_nearby.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ViewAllStreams.this, NearbyStreams.class);
                    startActivity(intent);
                }
        });
